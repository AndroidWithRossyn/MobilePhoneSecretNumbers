...
import com.phonesecretcode.mobilelocator.coder.models.DataModel;
...
//    }
    ...
    public DataModel getCustomData() {
        return getObject("dataModel", DataModel.class);
    }

    public void setCustomData(DataModel model) {
        putObject("dataModel", model);
    }
