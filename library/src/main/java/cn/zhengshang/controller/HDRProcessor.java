...
/*
import cn.zhengshang.ScriptC_align_mtb;
import cn.zhengshang.ScriptC_create_mtb;
import cn.zhengshang.ScriptC_histogram_adjust;
import cn.zhengshang.ScriptC_histogram_compute;
import cn.zhengshang.ScriptC_process_hdr;*/
...
//            createMTBScript.forEach_create_mtb(allocations[i], launch_options);
			...
			/*if( MyDebug.LOG ) {
				...
				try {
					...
					mActivity.getStorageUtil().broadcastFile(file, true, false, true);
				}
				catch(IOException e) {
					e.printStackTrace();
				}
