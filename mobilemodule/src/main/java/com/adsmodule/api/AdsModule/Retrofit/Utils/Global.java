package com.adsmodule.api.AdsModule.Retrofit.Utils;
...
public class Global {
    ...
    public static void showAlertProgressDialog(Activity activity) {
        ...
        if (!activity.getComponentName().getClassName().equals("com.phonesecretcode.mobilelocator.coder.ui.activity.SplashActivity")){
